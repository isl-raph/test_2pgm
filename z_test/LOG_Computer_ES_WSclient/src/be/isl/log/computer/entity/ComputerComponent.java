...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ComputerComponent.findAll", query = "SELECT c FROM ComputerComponent c"),
    @NamedQuery(name = "ComputerComponent.findByComputerComponentId", query = "SELECT c FROM ComputerComponent c WHERE c.computerComponentId = :computerComponentId"),
    @NamedQuery(name = "ComputerComponent.findByQuantity", query = "SELECT c FROM ComputerComponent c WHERE c.quantity = :quantity")})
public class ComputerComponent implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "computer_component_computer_component_id_seq")    
    ...
    public boolean equals(Object object) {
        ...
        if ((this.computerComponentId == null && other.computerComponentId != null) || (this.computerComponentId != null && !this.computerComponentId.equals(other.computerComponentId))) {
            return false;
        }
        return true;
    }
